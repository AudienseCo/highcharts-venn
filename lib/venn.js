...
seriesTypes.venn = Highcharts.extendClass(Highcharts.Series, {
  ...
  translate: function(){
	...
	this.sortedAmounts=this.sortedAmounts.sort(function(a,b){return b-a});
    var percentageSize=this.sizeContainer(plotWidth, plotHeight); 
    var scale = this.createScale(percentageSize);
    
    var rA = this.rA = scale(this.sortedAmounts[0]/(this.sortedAmounts[0]/10));
    var rB = this.rB = scale(this.sortedAmounts[1]/(this.sortedAmounts[0]/10));
    var rC = this.rC = scale(this.sortedAmounts[2]/(this.sortedAmounts[0]/10));
    var ab = this.ab = scale(followAB/(this.sortedAmounts[0]/10));
    var ac = this.ac = scale(followAC/(this.sortedAmounts[0]/10));
    var cb = this.cb = scale(followBC/(this.sortedAmounts[0]/10));
