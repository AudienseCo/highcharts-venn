...
seriesTypes.venn = Highcharts.extendClass(Highcharts.Series, {
  ...
  translate: function(){
    var chart = this.chart,
        ...
        ab = this.options.intersections[0],
        bc = this.options.intersections[1],
        ac = this.options.intersections[2] || null,
        rA = this.options.data[0],
        rB = this.options.data[1],
        rC = this.options.data[2] || null;
