...
seriesTypes.venn = Highcharts.extendClass(Highcharts.Series, {
  ...
  translate: function(){
    ...
    var rA = this.rA = scale(this.sortedAmountsInter[0]/(this.sortedAmountsInter[0]/17));
    var rB = this.rB = scale(this.sortedAmountsInter[1]/(this.sortedAmountsInter[0]/17));
    var rC = this.rC = scale(this.sortedAmountsInter[2]/(this.sortedAmountsInter[0]/17));
    var ab = this.ab = scale(this.sortedAmountsInter[3]/(this.sortedAmountsInter[0]/17));
    var ac = this.ac = scale(this.sortedAmountsInter[4]/(this.sortedAmountsInter[0]/17));
    var cb = this.cb = scale(this.sortedAmountsInter[5]/(this.sortedAmountsInter[0]/17));
    console.log(this.rB);
    ...
    this.data[2].shapeArgs = {
      ...
      var  interI=clone(this.data[0]); //     
       
       // interI=Object.create(interI.__proto__);
       //  console.log(interI); 
    interI.shapeType = 'path';
    interI.shapeArgs = {
...
// C  CIRCLE
  ...
  sizeContainer: function(width, height){ 
    this.cA.x=(width*0.40);//0.40
    this.cA.y=(height*0.68);
    return height/2;
  },
