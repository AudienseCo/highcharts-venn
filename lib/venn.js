...
seriesTypes.venn = Highcharts.extendClass(Highcharts.Series, {
  ...
  translate: function(){
     var auxArr = [this.data[0], this.data[1], this.data[2]];
	   auxArr.sort(function(b, a) {
      return a.y - b.y;
	   });
     this.data[0] = auxArr[0];
     this.data[1] = auxArr[1];
     this.data[2] = auxArr[2];
